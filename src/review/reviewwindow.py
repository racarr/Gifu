...
import gifu.actors.gobanactor
import gifu.engine.board

import gifu.sgf.sgflib
...
class ReviewWindow(gtk.Window):
    ...
    def __make_board(self):
        self.board = gifu.engine.board.Board()
        self.goban = gifu.actors.gobanactor.GobanActor(self.board)
    ...
    def __parse_sgf(self,path):
        ...
        self.game_tree = gifu.sgf.sgflib.SGFParser(data).parseOneGame()
